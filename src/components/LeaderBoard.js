            ...
            <div className='cardAlign'>
                { usersDetails.slice(0, 3).map((user,indx) => (
                    <Card style={{boxShadow: "5px 5px #888888"}} key={indx} className="cardAlign">
                        {indx===0?<div className="ui red left corner label">1st</div>:null}
                        {indx===1?<div className="ui orange left corner label">2nd</div>:null}
                            ...
                            <Col sm="3">
                                <Card style={{margin:"20px"}}>
                                    <center>
                                        ...
                                        <div style={{margin:"20px"}} className="ui blue big circular label">{user.score}</div>
                                    </center>
                                </Card>
                            </Col>
                        </Row>
